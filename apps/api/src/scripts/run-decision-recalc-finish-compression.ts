...
async function main() {
  ...
  try {
    ...
    const markdown = renderDecisionRecalcFinishCompressionMarkdown(result);
      ...
      : {
          ...
          compressionSummary: {
            ...
            decisionRecalcKeptRunningCount:
              result.decisionRecalcKeptRunningCount,
            decisionRecalcPromotedArchivedCount:
              result.decisionRecalcPromotedArchivedCount,
            decisionRecalcPromotedDeletedCount:
              result.decisionRecalcPromotedDeletedCount,
            decisionRecalcSuppressedFromRemainingCount:
              result.decisionRecalcSuppressedFromRemainingCount,
