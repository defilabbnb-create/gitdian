...
async function main() {
  ...
  try {
    ...
    const result = await service.runFrozenPoolCompletionPass();
    const markdown = renderFrozenAnalysisPoolCompletionMarkdown(result);
    ...
    const payload = options.json
      ...
      : {
          ...
          completionSummary: {
            completedUseful: result.frozenPoolCompletedUsefulCount,
            completedDeleted: result.frozenPoolCompletedDeletedCount,
            completedArchived: result.frozenPoolCompletedArchivedCount,
