...
- elliot736/janus：本地=GOOD BUILD / Claude=OK CLONE / 最终=OK CLONE
...
- OpenHuge/HugeCode：本地=GOOD BUILD / Claude=OK CLONE / 最终=OK CLONE
- qnknown/it-blog：本地=OK CLONE / Claude=N/A  / 最终=OK CLONE
